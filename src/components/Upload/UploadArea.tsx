          ...
          <div className={'flex justify-center align-center px-16 py-16 bg-gray-500 rounded-sm'}>
            <div className="space-y-1 text-center justify-center">
              ...
              <div className="flex text-xs text-white align-center">
                ...
                <label className="relative cursor-pointer bg-white rounded-md font-medium text-white hover:text-indigo-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-indigo-500">
